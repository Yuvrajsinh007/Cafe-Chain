...
const defaultSender = { 
  email: process.env.EMAIL_FROM || process.env.EMAIL_USER || 'no-reply@cafechain.in', 
  name: 'CafeChain' // Updated from 'Car Rental'
};
...
module.exports = { sendEmail, sendOtpEmail, generateOTP };