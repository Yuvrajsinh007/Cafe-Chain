...
const TermsAndConditionsPage = () => {
    ...
    return (
        <motion.div
            ...
            // Adjusted padding: pt-20 for mobile nav clearance
        ...
        >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-16">
                ...
                <div className="text-center mb-8 md:mb-10">
                    ...
                    <h1 className="text-2xl md:text-5xl font-bold mb-2">Terms and Conditions</h1>
                    <p className="text-xs md:text-base text-gray-500">Last Updated: August 30, 2025</p>
                </div>

                <div className="space-y-6 md:space-y-8 text-gray-700 leading-relaxed text-sm md:text-base">
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">1. Acceptance of Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">2. The Loyalty Program</h2>
                        <p>
                         ...
                         <ul className="list-disc list-inside pl-2 md:pl-4 mt-2 space-y-1">
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">3. Account Registration and Security</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">4. User Conduct</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">5. Termination</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">6. Disclaimers</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">7. Limitation of Liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">8. Changes to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">9. Contact Us</h2>
