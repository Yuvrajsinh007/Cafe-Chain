...
const PrivacyPolicyPage = () => {
    ...
    return (
        <motion.div
            ...
            // Adjusted padding: pt-20 for mobile nav clearance, reduced pb
            className="min-h-screen bg-white text-[#4a3a2f] font-sans pt-20 md:pt-0 pb-20"
        >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-16">
                <button
                    onClick={() => navigate(-1)}
                    className="flex items-center gap-1 md:gap-2 text-gray-500 hover:text-[#4a3a2f] transition-colors mb-6 md:mb-8 font-semibold focus:outline-none focus:ring-0 border-none text-sm md:text-base"
                >
                ...
                <div className="text-center mb-8 md:mb-10">
                    ...
                    <h1 className="text-2xl md:text-5xl font-bold mb-2">Privacy Policy</h1>
                    <p className="text-xs md:text-base text-gray-500">Effective Date: August 6, 2025</p>
                </div>

                <div className="space-y-6 md:space-y-8 text-gray-700 leading-relaxed text-sm md:text-base">
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">1. Introduction</h2>
                        <p>By creating an account or using our Service, you agree to the terms outlined in this policy.</p>
                    </section>

                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">2. Information We Collect</h2>
                        ...
                        <div className="mt-3 md:mt-4 space-y-3 md:space-y-4">
                            <div>
                                <h3 className="text-base md:text-xl font-semibold text-[#4a3a2f]">A. Information You Provide Directly</h3>
                                <p>When you register for a loyalty account on our website, we collect the following information:</p>
                                <ul className="list-disc list-inside pl-2 md:pl-4 mt-1 md:mt-2 space-y-1">
                            ...
                            <div>
                                <h3 className="text-base md:text-xl font-semibold text-[#4a3a2f]">B. Information Collected During In-Store Purchases</h3>
                                ...
                                <p className="mt-1 md:mt-2">We do not collect itemized details of your bill or any payment information (like credit card details). This transactional data is linked to your account solely for the purpose of administering loyalty points.</p>
                            </div>
                            <div>
                                <h3 className="text-base md:text-xl font-semibold text-[#4a3a2f]">C. Information from Third Parties</h3>
                            ...
                            <div>
                                <h3 className="text-base md:text-xl font-semibold text-[#4a3a2f]">D. Automatically Collected Usage Data</h3>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">3. How We Use Your Information</h2>
                    ...
                    <section>
                        <h2 className="text-lg md:text-2xl font-bold text-[#4a3a2f] mb-2 md:mb-3">Contact Us</h2>
                        <p>If you have any questions or concerns about this Privacy Policy, please contact us at:</p>
                        <div className="mt-3 md:mt-4 bg-stone-50 p-4 rounded-lg border border-stone-200 text-sm md:text-base">
